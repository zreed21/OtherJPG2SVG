...
//#region extensions/aligning_guidelines/util/get-objects-by-target.ts
...
function deleteObjectsByList(objects, list) {
	for (const target of list) if (target.constructor == Group) deleteObjectsByList(objects, target.getObjects());
	else objects.delete(target);
}
